...
router.post("/admin/login", adminsController.adminLogin);
router.get("/admin/users", adminsController.allUsers);
router.delete("/admin/users/:userId", adminsController.delUser);
router.get("/admin/posts", adminsController.allPosts);
router.delete("/admin/posts/:postId", adminsController.delPost);
router.get("/admin/comments", adminsController.allComments);
router.delete("/admin/comments/:commentId", adminsController.delComment);
